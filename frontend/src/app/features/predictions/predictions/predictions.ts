  ...
  generateWorkoutRecommendation(): void {
    ...
    this.predictionService
      ...
      .subscribe({
        ...
        next: (
          result: WorkoutWeightPrediction
        ) => {

          this.workoutRecommendation.set(
            result
          );
